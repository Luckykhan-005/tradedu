...
/**
 * Hooks for JournalEntry routes
 */
export interface JournalEntryHooks {
  /**
...
/**
 * Default JournalEntry hooks (customize as needed)
 */
export const journalEntryHooks: JournalEntryHooks = {
