...
/**
 * Auto-generated JournalEntry Routes
 *
...
import type { JournalEntryHooks } from "./journal-entry.hooks"
...
/**
 * Set hooks for JournalEntry routes
 */
export function setJournalEntryHooks(h: JournalEntryHooks) {
  hooks = h
}
...
const WRITABLE_SCALAR_FIELDS = ["userId", "date", "pair", "direction", "entry", "exit", "stopLoss", "takeProfit", "size", "setup", "notes", "pnl", "createdAt"] as const
...
/**
 * Create JournalEntry CRUD routes
 */
export function createJournalEntryRoutes(): Hono {
  ...
  router.get("/:id", async (c) => {
    try {
      ...
      if (!item) {
        return sendJson(c, { error: { code: "not_found", message: "JournalEntry not found" } }, 404)
      }
