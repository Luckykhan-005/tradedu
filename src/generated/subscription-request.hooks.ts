...
/**
 * Hooks for SubscriptionRequest routes
 */
export interface SubscriptionRequestHooks {
  /**
...
/**
 * Default SubscriptionRequest hooks (customize as needed)
 */
export const subscriptionRequestHooks: SubscriptionRequestHooks = {
