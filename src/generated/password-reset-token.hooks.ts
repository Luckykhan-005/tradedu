...
/**
 * Hooks for PasswordResetToken routes
 */
export interface PasswordResetTokenHooks {
  /**
...
/**
 * Default PasswordResetToken hooks (customize as needed)
 */
export const passwordResetTokenHooks: PasswordResetTokenHooks = {
